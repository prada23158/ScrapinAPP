<x-layouts.app :title="__('Contacts France Travail')">
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Contacts France Travail') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">
            {{ __('Gérer les contacts France Travail de l\'application') }}
        </flux:subheading>
