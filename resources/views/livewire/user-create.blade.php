<div>
    <flux:modal name="create-user" class="md:w-150">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">Créer un Compte</flux:heading>
                <flux:text class="mt-2">Ajouter les informations du compte de l'utilisateur</flux:text>
            </div>
            ...
            <div class="flex items-center justify-end">
                <flux:button type="submit" variant="primary" class="w-full" data-test="register-user-button" wire:click="createUser">
                    {{ __('Créer un compte') }}
                </flux:button>
            </div>
        </div>
